...
context.keymap(
    {
        ...
        "(tag | ellie) article": CursorText("<article class=\"\">{.}</article>"),
        ...
        "(tag | ellie) div": CursorText("<div class=\"\">{.}</div>"),
        ...
        "(tag | ellie) heading one": CursorText("<h1 class=\"\">{.}</h1>"),
        "(tag | ellie) heading two": CursorText("<h2 class=\"\">{.}</h2>"),
        "(tag | ellie) heading three": CursorText("<h3 class=\"\">{.}</h3>"),
        "(tag | ellie) heading four": CursorText("<h4 class=\"\">{.}</h4>"),
        "(tag | ellie) heading five": CursorText("<h5 class=\"\">{.}</h5>"),
        "(tag | ellie) heading six": CursorText("<h6 class=\"\">{.}</h6>"),
        "((tag | ellie) paragraph | (tag | ellie) pee)": CursorText("<p class=\"\">{.}</p>"),
		...
		"(tag | ellie) link css": CursorText('<link href="{.}" rel="stylesheet">'),
        "(tag | ellie) hyperlink": CursorText('<a href="" alt="" class=\"\">{.}</a>'),
        "(tag | ellie) open hyperlink": CursorText('<a href="{.}" alt="">'),
        "(tag | ellie) close hyperlink": CursorText("{.}</a>"),
        "(tag | ellie) image": CursorText('<img src="{.}" alt="" title=""  class=\"\" />'),
        "(tag | ellie) her": "<hr>",
        "(tag | ellie) burr": "<br>",
